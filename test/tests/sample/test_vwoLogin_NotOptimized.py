...
def test_app_vwo_login_chrome():
    ...
    take_screen_shot(driver=driver, name="vwo login step-1")
    ...
    take_screen_shot(driver=driver,name="vwo login step-2")
    ...
    take_screen_shot(driver=driver,name="vwoLoginFailed-step3")
